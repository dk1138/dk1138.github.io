        ...
        this.app.state.projectionData.forEach((d) => {
            ...
            if (this.app.state.mode === 'Couple') {
                if (d.events.includes('P1 Dies') && d.p2Alive) {
                    assetTitle += ` <i class="bi bi-info-circle text-warning ms-1 info-btn" style="font-size: 0.85rem; cursor: help;" tabindex="0" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-custom-class="projection-popover" data-bs-title="Spousal Rollover (P1 &rarr; P2)" data-bs-content="Person 1 passed away this year. Under CRA rules, their registered accounts (RRSP/RRIF, TFSA) and non-registered investments are transferred directly to Person 2 <b>tax-free</b>. No deemed disposition tax is triggered on these assets at this time."></i>`;
                }
                if (d.events.includes('P2 Dies') && d.p1Alive) {
                    assetTitle += ` <i class="bi bi-info-circle text-purple ms-1 info-btn" style="font-size: 0.85rem; cursor: help;" tabindex="0" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-custom-class="projection-popover" data-bs-title="Spousal Rollover (P2 &rarr; P1)" data-bs-content="Person 2 passed away this year. Under CRA rules, their registered accounts (RRSP/RRIF, TFSA) and non-registered investments are transferred directly to Person 1 <b>tax-free</b>. No deemed disposition tax is triggered on these assets at this time."></i>`;
                }
            }
