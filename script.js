...
class RetirementPlanner {
    ...
    showVersion() {
        const h = document.querySelector('h3') || document.querySelector('.navbar-brand');
        if(h && !h.innerHTML.includes(this.APP_VERSION)) {
            h.innerHTML += ` <span class="badge bg-secondary ms-2" style="font-size:0.5em; vertical-align:middle;">v${this.APP_VERSION}</span>`;
        }
    }
