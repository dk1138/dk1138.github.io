/**
 * Retirement Planner Pro - Logic v10.41 (Surplus Tax Fix)
 * * Changelog:
 * - v10.41: FIXED: "Surplus" calculation now correctly subtracts taxes generated by deficit withdrawals. previously, the tax portion of a gross-up withdrawal appeared as a cash surplus.
 * - v10.40: IMPROVED: RRSP/RRIF withdrawals prioritize lower-income spouse first.
 * - v10.39: FIXED: Income Growth rate variable lookup.
 */
class RetirementPlanner {
    constructor() {
        this.APP_VERSION = "10.41";
        this.state = {
            inputs: {},
            debt: [],
    ...
    generateProjectionTable(onlyCalcNW = false) {
        ...
        for (let i=0; i<=yearsToRun; i++) {
            ...
            if (surplus > 0) {
                ...
                surplus -= addedTax; // Adjust surplus to account for tax paid from withdrawal
            }
            ...
            if(!onlyCalcNW) {
                ...
                // Effective surplus is what is left in pocket.
                // If surplus was -100, we withdrew 130 (100 net + 30 tax).
                // totalWithdrawals = 130.
                // surplus (variable) started as -100.
                // We adjusted surplus -= addedTax -> -100 - 30 = -130.
                // effectiveSurplus = -130 + 130 = 0. Correct.
                const effectiveSurplus = surplus + totalWithdrawals;
                
                // Net Cash = Net Income + Withdrawals - Expenses/Debt
                // It should basically match effectiveSurplus logic but absolute terms
                const hhNetCash = totalNetIncome + totalWithdrawals - (tax1.totalTax + tax2.totalTax); // This is effectively surplus + expenses
